...
//It returns a connection object if successful, which is stored in the variable `$conn`.
if(!$conn){
//     echo "succcess";
// }
// else{
 ...
 *If $conn evaluates to true (meaning the connection was successful), it echoes "success".
